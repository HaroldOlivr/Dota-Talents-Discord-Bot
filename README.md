...
| Huskar              | `::huskar`                                             |
| Invoker             | `::invoker` `::invo` `::injoker` `::voker` |
| Io                  | `::io`                                                 |
| Jakiro              | `::jakiro` `::jaki`                                |
...
| Silencer            | `::silencer`                                           |
| Skywrath Mage       | `::skywrath mage` `::skywrath` `::sky`         |
| Slardar             | `::slardar`                                            |
| Slark               | `::slark`                                              |
| Sniper              | `::sniper`                                             |
...
| Sven                | `::sven`                                               |
| Techies             | `::techies`                                            |
| Templar Assasin     | `::templar assasin` `::ta`                         |
...
| Witch Doctor        | `::witch doctor` `::witch`                         |
| Wraith King         | `::wraith king` `::wk` `::drakus`              |
| Zeus                | `::zeus`                                               |
